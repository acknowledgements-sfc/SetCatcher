...
///
/// Status methods are pure. `applyRouteToDJMemoryDriver` / `restorePreviousRoute`
...
public protocol DJAppOutputRoutingAdapter: Sendable {
    ...
    func applyRouteToDJMemoryDriver() -> DJAppRoutingOutcome
...
public struct SeratoOutputRoutingAdapter: DJAppOutputRoutingAdapter {
    ...
    public func applyRouteToDJMemoryDriver() -> DJAppRoutingOutcome {
        .notAutomatedYet
    }
