...
final class PublishExportServiceTests: XCTestCase {
    func testExportPackCopiesAudioAndWritesTracklistText() throws {
        ...
        let archive = ArchiveMetadata(
            session: RecordingSession(sourceAppID: SupportedDJSoftware.captureAppID, sourceURL: URL(fileURLWithPath: "/DJMemoryCapture/DJM/set.wav"), archiveURL: archiveFile, fileSize: 5, status: .archived),
